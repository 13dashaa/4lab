...
//    const std::string& speciality, const std::vector<std::string>& scientific_works, const std::string& position,
//    const std::string& party_name, const std::vector<std::string>& autobiography,
...
//{
//    list.show();
//    return os;// TODO: вставьте здесь оператор return
//}
//
//
//
//
//template<class T>
//List<T> getList(int mark) {
//    if (mark == 1)
//        return List<Person>();
//    else if (mark == 2)
//        return List<Teacher>();
//    else if (mark == 3)
//        return List < Party_member>();
//    else
//        return List<PoliticalEducator>();
//}
//
//template <typename T>
